...
- The [Jing-Trang multi-format schema converter](https://github.com/relaxng/jing-trang) is used for XML Schema generation and validation from RELAX NG schema.
...
- [Schematron Testing Framework (stf) iso_abstract_expand.xsl](https://github.com/Schematron/stf/blob/master/iso-schematron-xslt2/iso_abstract_expand.xsl) is used for [abstract pattern](https://github.com/TEIC/TEI/issues/1981) extract from the schematron files - due to [jing limitation](https://github.com/relaxng/jing-trang/issues/60)
