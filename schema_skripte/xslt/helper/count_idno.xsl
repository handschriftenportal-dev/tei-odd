...
<xsl:stylesheet 
    ...
    <xsl:variable name="listDSC" select="doc('../../../nachweis_daten/catalog_DSC.xml')"/>
    <xsl:variable name="listTEI" select="doc('../../../nachweis_daten/catalog_DSC-TEI.xml')"/>
    <xsl:variable name="listDIG" select="doc('../../../nachweis_daten/catalog_DIG.xml')"/>
