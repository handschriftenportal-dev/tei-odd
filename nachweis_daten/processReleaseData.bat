...
//MXML-to-TEI-P5_obj
java -cp "C:\Users\schassan\Documents\_Software\Saxon\saxon-he-12.3\saxon-he-12.3.jar" net.sf.saxon.Transform -t -s:_testdaten\_obj_testdatenset.xml -xsl:..\MXML2TEI\MXML-to-TEI-P5.xsl -o:_MXML-to-TEI-HSP_result\_obj_testdatenset_TEI-HSP.xml TEI-schema=4.6.0
java -cp "C:\Users\schassan\Documents\_Software\Saxon\saxon-he-12.3\saxon-he-12.3.jar" net.sf.saxon.Transform -t -s:catalog_DSC.xml -xsl:..\schema_skripte\xslt\helper\process_MXML-to-TEI-HSP.xsl TEI-schema=4.6.0
...
//TEI-to-TEI
java -cp "C:\Users\schassan\Documents\_Software\Saxon\saxon-he-12.3\saxon-he-12.3.jar" net.sf.saxon.Transform -t -s:catalog_DSC-TEI.xml -xsl:..\schema_skripte\xslt\helper\process_TEI-to-TEI-HSP.xsl TEI-schema=4.6.0
